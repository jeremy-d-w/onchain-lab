import { isOnChain, getFieldsForPath, isAuthorized } from './policy';

// Mock storage for our simulated database
...
// Mock on-chain storage (separate from off-chain for demonstration)
 ...
 * This is aware of on-chain vs off-chain storage based on policy
 */
